...
ecl:grn pid:012533040 byr:1946") == false
     ...
     pid:3556412378 byr:2007") == false
        ...
        assert Puzzle4Part2.is_valid_passport("pid:087499704 hgt:74in ecl:grn iyr:2012 eyr:2030 byr:1980
     hcl:#623a2f") == true
     ...
     eyr:2022") == true
        assert Puzzle4Part2.is_valid_passport("iyr:2010 hgt:158cm hcl:#b6652a ecl:blu byr:1944 eyr:2021 pid:093154719") == true
  end
