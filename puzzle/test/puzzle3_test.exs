...
.#.......#......#.##..##...#..."
  ...
  test "right 3：超过右边界，则地图向右复制一倍。可以使用 取模，重新回到第一列" do
    ...
    assert Puzzle3.go_right_and_down(1, @line_length_of_sample - 2, 3, 1, @line_count_of_sample, @line_length_of_sample) == %{
             line: 2,
             column: 1
           }

    assert Puzzle3.go_right_and_down(1, @line_length_of_sample - 1, 3, 1, @line_count_of_sample, @line_length_of_sample) == %{
             line: 2,
             column: 2
           }

    assert Puzzle3.go_right_and_down(1, @line_length_of_sample, 3, 1, @line_count_of_sample, @line_length_of_sample) == %{
             line: 2,
             column: 3
           }
  end
